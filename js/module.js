registerController('PMKIDAttack_Controller', ['$api', '$scope', '$rootScope', '$interval', '$timeout', function($api, $scope, $rootScope, $interval, $timeout) {
	$scope.title = "Loading...";
...
registerController('PMKIDAttack_ControlsController', ['$api', '$scope', '$rootScope', '$interval', '$timeout', function($api, $scope, $rootScope, $interval, $timeout) {
...
registerController('PMKIDAttack_OutputController', ['$api', '$scope', '$rootScope', '$interval', function($api, $scope, $rootScope, $interval) {
...
registerController('PMKIDAttack_HistoryController', ['$api', '$scope', '$rootScope', function($api, $scope, $rootScope) {
	$scope.history = [];
...
registerController('PMKIDAttack_OptionsController', ['$api', '$scope', '$rootScope', function($api, $scope, $rootScope) {

// COMMAND OUTPUT

	$scope.command = "hcxdumptool ";
...
// HCXOPTIONS
	...
	$scope.update = (function(param) {
		$scope.command = "hcxdumptool " + updateInterface() + updateOptions() + updateProto() + updateVisualization() + updateFilter() + updateMITM() + updateTarget1() + updateTarget2()
...
registerController('PMKIDAttack_EditorController', ['$api', '$scope', '$rootScope', '$timeout', function($api, $scope, $rootScope, $timeout) {
	$scope.filters = [];
	$scope.selectedFilter = "--";
